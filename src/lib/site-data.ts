...
export const posts: BlogPost[] = [
  {
    ...
    title: "چگونه یک فیلم‌بردار عروسی سینمایی انتخاب کنیم؟",
    excerpt: "راهنمای کامل انتخاب فیلم‌بردار عروسی: تفاوت پوشش مستند و روایت سینمایی، تجهیزات، و ارزیابی نمونه‌کارها.",
    body: "انتخاب فیلم‌بردار عروسی یکی از مهم‌ترین تصمیم‌های شماست. در این راهنما به تفاوت‌های اصلی بین «پوشش مستند» و «روایت سینمایی» می‌پردازیم؛ اولی همه لحظه‌ها را ثبت می‌کند و دومی داستان شب شما را با کارگردانی، نور و تدوین سینمایی بازآفرینی می‌کند.\n\nتجهیزات مهم‌اند اما تنها معیار نیستند: دوربین‌های فول‌فریم، لنزهای روشن، گیمبال، صدای بی‌سیم و نور پرتابل حداقل ابزارهای یک تیم حرفه‌ای است. مهم‌تر از تجهیزات، «چشم کارگردان» و تسلط بر رنگ‌بندی سینمایی است.\n\nهنگام ارزیابی نمونه‌کارها به این نکته‌ها توجه کنید: کیفیت رنگ و نور در نماهای شب، ریتم و ساختار روایت، کیفیت صدا (نه فقط موسیقی)، تنوع سبک بین پروژه‌های مختلف، و تحویل نسخه‌های افقی و عمودی برای شبکه‌های اجتماعی. حتماً حداقل دو فیلم کامل ببینید، نه صرفاً تیزر یک‌دقیقه‌ای.\n\nدر نهایت، قرارداد شفاف با ذکر تعداد نوبت اصلاح، زمان تحویل و مالکیت فایل خام، خیال شما را از هر ابهامی راحت می‌کند.",
    date: "۱۴۰۳/۰۹/۰۱",
    readTime: "۷ دقیقه",
    cover: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200&h=800&q=80",
  },
